CREATE TABLE Guide
(GuideNum VARCHAR2(4) PRIMARY KEY,
...
(CustomerNum VARCHAR2(4) PRIMARY KEY,
...
ALTER TABLE RESERVATION
	ADD FOREIGN KEY (CustomerNum) REFERENCES Customer (CustomerNum);

ALTER TABLE RESERVATION
	ADD FOREIGN KEY (TripID) REFERENCES Trip (TripID);

ALTER TABLE TripGuides
	ADD FOREIGN KEY (GuideNum) REFERENCES Guide (GuideNum);
